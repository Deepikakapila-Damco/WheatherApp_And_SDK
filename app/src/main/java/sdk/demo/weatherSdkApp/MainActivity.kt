package sdk.demo.weatherSdkApp
...
import sdk.demo.weatherSdkApp.databinding.ActivityMainBinding
        ...
        weatherSDK.getCurrentWeather(latitude, longitude, WeatherSDK.TempUnit.CELSIUS,
            object : WeatherSDK.WeatherDataListener {
                override fun onWeatherResponse(response: WeatherResponse) {
                    binding.content.tvWeatherData.text = getString(R.string.my_xml_string, response.name, response.toString())
